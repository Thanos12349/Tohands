    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(deposite.this, "Phone number: " + phoneNumber, Toast.LENGTH_SHORT).show();
                Toast.makeText(deposite.this, "Data saved successfully", Toast.LENGTH_SHORT).show();
